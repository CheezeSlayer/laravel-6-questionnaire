...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <!-- $questionnaire was lazy loaded from QuestionnaireController@show allowing access to it's questions and questions answers -->
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            @foreach($question->answers as $answer)
                               <li class="list-group-tem d-flex justify-content-between">
